...
class BISACClassifier(Classifier):
    ...
    GENRE = [
        ...
        m(Business, nonfiction, "Business & Economics", "Real Estate"),
        m(Business, nonfiction, "Business & Economics"),
        # Parenting & Family
        m(Family_Relationships, nonfiction, "Family & Relationships", "Parenting"),
        m(Family_Relationships, nonfiction, "Family & Relationships"),
        # Food & Health
        m(Cooking, nonfiction, "Cooking", "Beverages"),
        m(Cooking, nonfiction, "Cooking", "Health & Healing"),
        m(Cooking, nonfiction, "Health & Fitness"),
        m(Cooking, nonfiction, "Cooking", "Vegetarian & Vegan"),
        m(Cooking, nonfiction, "Cooking"),
        # History
        m(History, nonfiction, "History", "Africa"),
        m(History, nonfiction, "History", "Ancient"),
        m(History, nonfiction, "History", "Asia"),
        m(History, nonfiction, "History", "United States", RE("^Civil War")),
        m(History, nonfiction, "History", "Europe"),
        m(History, nonfiction, "History", "Latin America"),
        m(History, nonfiction, "History", "Medieval"),
        m(History, nonfiction, "History", "Military"),
        m(History, nonfiction, "History", "Renaissance"),
        m(
            History,
            nonfiction,
            "History",
        ...
        m(History, nonfiction, "History", "Modern"),
        m(History, nonfiction, "History", "Native American"),
        m(History, nonfiction, "History", "United States"),
        m(History, nonfiction, "History", "World"),
        m(History, nonfiction, "History", "Civilization"),
        ...
        m(Fantasy, fiction, "Fairy Tales & Folklore"),
        m(Fantasy, fiction, "Legends, Myths, Fables"),
        m(Games, nonfiction, "Games & Activities"),
        m(Cooking, nonfiction, "Health & Daily Living"),
        ...
        m(Fantasy, fiction, "Mysteries & Detective Stories"),
