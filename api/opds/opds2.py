...
from api.opds.accessibilty import AccessibilityDataExtension
...
from api.opds.types.language import LanguageMap
from api.opds.types.link import CompactCollection, LinkT
...
class AcquisitionLinkRelations(str, Enum):
    """
    https://drafts.opds.io/opds-2.0#53-acquisition-links
    """
