...
def create_lanes_for_finnish_collection(_db, library, language="fin", priority=1000):
    ...
    adult_fiction_suspense.sublanes.append(
        lane_from_genres(
            _db,
            library,
            display_name="Kaikki jännityskirjat",
            genres=[
                genres.Suspense_Thriller,
                genres.Historical_Thriller,
                genres.Psychological_Thriller,
    ...
    adult_fiction.sublanes.append(
        lane_from_genres(
            ...
            genres=[genres.Classics, genres.Stories_Myths],
            priority=adult_fiction_priority,
            **adult_common_args,
        )
    )
    ...
    adult_nonfiction.sublanes.append(
        lane_from_genres(
            ...
            genres=[
                ...
                genres.Activism_Biographies,
                genres.Actors_Biographies,
                genres.Artists_Biographies,
                genres.Authors_Biographies,
                genres.Crime_Law_Enforcement_Biographies,
                genres.Emergency_Services_Biographies,
                genres.Foreign_Cultures_Biographies,
                genres.Journalists_Biographies,
                genres.Historical_Biographies,
                genres.LGBTQ_Biographies,
                genres.Medical_Professionals_Biographies,
                genres.Music_Biographies,
                genres.Philosophical_Biographies,
                genres.Public_Figures_Biographies,
                genres.Religious_Biographies,
                genres.Rulers_Politicians_Biographies,
                genres.Survival_Stories_Biographies,
                genres.War_Biographies,
            ],
    ...
    adult_nonfiction_priority += 1
    adult_history.add_genres(
        [
            genres.History.name,
            genres.War_Nonfiction.name,
        ]
    )
    adult_nonfiction.sublanes.append(adult_history)
    adult_history.sublanes.append(
        lane_from_genres(
            _db,
            library,
            display_name="Historia",
    ...
    adult_history.sublanes.append(
        lane_from_genres(
            _db,
            library,
            display_name="Kaikki historiakirjat",
            genres=[
                genres.History,
                genres.War_Nonfiction,
            ],
    ...
    adult_society.add_genres(
        [
            ...
            genres.Law.name,
            genres.Ethics_Moral_Philosophy.name,
    ...
    adult_society.sublanes.append(
        lane_from_genres(
            ...
            genres=[genres.Philosophy, genres.Ethics_Moral_Philosophy],
            priority=1,
            **adult_common_args,
        )
    )
    ...
    adult_society.sublanes.append(
        lane_from_genres(
            _db,
            library,
            display_name="Kaikki yhteiskuntakirjat",
            genres=[
                genres.Society,
                genres.Political_Science,
                genres.Law,
    ...
    adult_economics.add_genres(
        [
            genres.Investing.name,
            genres.Marketing.name,
    ...
    adult_economics.sublanes.append(
        lane_from_genres(
            ...
            genres=[genres.Management_Leadership],
            priority=2,
            **adult_common_args,
        )
    )
    ...
    adult_psychology.sublanes.append(
        lane_from_genres(
            ...
            genres=[genres.Psychology, genres.Life_Management],
            priority=1,
            **adult_common_args,
        )
    )
    ...
    adult_spirit.sublanes.append(
        lane_from_genres(
            _db,
            library,
            display_name="Kaikki uskonto ja hengellisyys",
            genres=[
                genres.Religion_Spirituality,
    ...
    adult_science.sublanes.append(
        lane_from_genres(
            _db,
            library,
            display_name="Kaikki tiede ja teknologia",
            genres=[
                genres.Technology,
                genres.Computers,
                genres.Internet,
...
def create_lanes_for_swedish_collection(_db, library, language="swe", priority=2000):
    ...
    adult_fiction, ignore = create(
        ...
        Lane,
        library=library,
        display_name="Skönlitteratur för vuxna",
        genres=[],
        fiction=True,
        sublanes=[],
        priority=1,
    ...
    adult_fiction_all, ignore = create(
        ...
        Lane,
        library=library,
        display_name="Alla skönlitteratur för vuxna",
        genres=[],
        priority=adult_fiction_priority,
        **adult_common_args,
    )
    ...
    adult_nonfiction, ignore = create(
        ...
        Lane,
        library=library,
        display_name="Facklitteratur för vuxna",
        genres=[],
        sublanes=[],
        fiction=False,
        priority=2,
    ...
    adult_nonfiction_all, ignore = create(
        ...
        Lane,
        library=library,
        display_name="Alla facklitteratur för vuxna",
        fiction=False,
        priority=adult_nonfiction_priority,
        **adult_common_args,
    )
