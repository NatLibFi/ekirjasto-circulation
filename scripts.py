...
class CollectTranslationsScript(Script):
    ...
    def _collect_lanes(self):
        # Create temporarily library just to create default lanes.
        public_key, private_key = Library.generate_keypair()
        library, ignore = create(
            self._db,
            Library,
            uuid=str(uuid.uuid4()),
            short_name="temp_to_collect_default_lanes",
        ...
        lanes = (
            ...
            .order_by(Lane.display_name)
        )

        with open("default_lane_names_to_localize.py", "w") as file:
            file.write("from flask_babel import lazy_gettext as _\n\n")
            file.write("# DO NOT EDIT THIS FILE MANUALLY!\n")
            file.write(
                "# This file was generated by the CollectTranslationsScript class.\n\n"
    ...
    def _collect_display_texts(self):
        with open("core/data_conversion/localized_w3c_display_texts.py", "w") as file:
            file.write("from flask_babel import lazy_gettext as _\n\n")
            file.write("# DO NOT EDIT THIS FILE MANUALLY!\n")
            file.write(
                "# This file was generated by the CollectTranslationsScript class.\n\n"
            )
            file.write("w3c_display_texts = {\n")

            # Get the attributes of the W3CDisplayTexts class and write the localizable display texts to file.
            for name, value in getmembers(W3CDisplayTexts):
                if not name.startswith("__") and not ismethod(value):
                    file.write(f'    "{value}": _("{value}"),\n')
